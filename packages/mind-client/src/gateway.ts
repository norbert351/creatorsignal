 ...
 * envelopes are pushed to the real Mind over Telegram; the Mind's replies
 * arrive asynchronously through the message handler.
 */
export interface MindGateway {
  readonly mode: 'simulated' | 'telegram'
